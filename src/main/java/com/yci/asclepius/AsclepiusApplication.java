...
@SpringBootApplication(scanBasePackages = {"com.yci.asclepius"})
...
public class AsclepiusApplication {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext run = SpringApplication.run(AsclepiusApplication.class);
